        ...
        <div class="card col-md-8 o-hidden border-0 shadow-lg my-5 ">
            <div class="card-body pt-5">
                ...
                <div class="row pt-5">
                    ...
                    <div class="col-md-3 pt-5"><a style="font: 20px cairo; color: #FFFFFF" type="submit" class="btn btn-block float-right" id="newContactInfoBtn" data-toggle="modal" data-target="#exampleModal"><img class="pr-2" src="{{asset('img/Icon ionic-ios-add.svg')}}" alt=""/>New Contact Information</a></div>
                </div>
                <div class="row">
                    <div class="col-md-4 pl-5 pr-5">
                        <div class="row pt-5">
                            <div class="col-md-2 pt-2 "><img src="{{asset('img/Facebook.svg')}}" alt="" style="width: 40px; height: 40px;"/></div>
                            <div class="col-md-7">
                            ...
                            <div class="col-md-3 pt-2"> <img data-toggle="modal" data-target="#exampleModal4" class="float-right" src="{{asset('img/Group 322.svg')}}" alt=""/></div>
