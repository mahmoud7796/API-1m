        ...
        <div class="row pt-4">
          ...
          <div style="border-top: 10px solid #9EC2EA; background-color: #F5F7FA; border-radius: 10px;" class="col-md-6 pl-3">
            <div class="row pt-5">
              ...
              <div class="col-md-5">
                <div class="row justify-content-center">
                  <div class="col-md-4"> <a href="" style=" font: 14px Cairo; color: #1F2933; background: #E9901C 0% 0% no-repeat padding-box; width: 81px; height: 40px; border-radius: 25px;" class="btn btn-block">4 Scans</a> </div>
                  <div class="col-md-4"> <a href="" style=" font: 14px Cairo; color: #FFFFFF; background: #52606D 0% 0% no-repeat padding-box; width: 81px; height: 40px; border-radius: 25px;" class="btn btn-block">3 Adds</a> </div>
                </div>
              </div>
            </div>
