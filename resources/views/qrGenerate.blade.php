            ...
            <div class="card-body p-5">
                ...
                <div>
                    <div class="row pl-5 pt-5 contact">
                        ...
                        <div class="col-md-5">
                            <img class="qrCodeImg" src="{{asset('public/'.$cards->qr_url)}}" width="211" height="209" alt=""/>
                        </div>
                    </div>
                </div>
                ...
                <div class="row pt-5 powered">
                    <div class="col-md-7 element">
                        <div class="row title1me">
                            <h4 class="poweredBy" style="font: normal normal bold 24px/45px Cairo; letter-spacing: 0px; color: #1F2933;">Powered by 1Me</h4>
                            <img class="ml-2 logo" src="{{asset('img/OneMeLogo@2x.png')}}" width="72" height="34" alt=""/></div>
                        <div class="row">
                            <h6 class="details" style="font: normal normal normal 18px/33px Cairo; letter-spacing: 0px; color: #52606D;">With 1Me you can create cards just like this.</h6>
                        </div>
                    </div>
                    <div class="col-md-5 pl-5 getYours"> <a href="{{route('site.register')}}" style="margin-left:-25px;font: 20px/32px Cairo; color: #FFFFFF; background: #E7A82D 0% 0% no-repeat padding-box; box-shadow: 2px 2px 4px #00000029; border-radius: 15px; width: 187px; height: 54px;" type="submit" class="btn btn-block" id="">Get Yours Now</a></div>
                </div>
            </div>
        </div>
    </div>
