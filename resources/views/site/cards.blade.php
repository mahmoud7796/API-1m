      ...
      <div class="card-body p-5"> 
        ...
        <div class="row justify-content-center pt-3">
          ...
          <div class="col-md-6 pt-5 pl-5 text-center">
            <div style="background-color: #E7F0FB; border-radius: 10px; height: 54px;" class="row justify-content-end">
              ...
              <div class="col-md-4 pt-2"><a style="font: normal normal normal 20px/32px cairo; color: #1F2933;" href="">Your Contact Info</a></div>
              <div class="col-md-4 pt-2"><a style="font: normal normal normal 20px/32px cairo; color: #1F2933;" href="">Your Contacts</a></div>
            </div>
          </div>
        </div>
        ...
        <!-- create card button -->
        <div class="row justify-content-center">
          <div class="col-md-3"> <a href=""  style="font: 20px Cairo; color: #FFFFFF"  class="btn btn-block" id="createCardBtn" data-toggle="modal" data-target="#exampleModal">Create Your First Card</a> </div>
        </div>
