                        ...
                        <div class="col-md-6">
                            @if(isset($cards) && $cards->count()>0)
                                            ...
                                            <div class="card-body row"> <a href="" class="col-md-7">
                                                ...
                                                <div class="col-md-5 ">
                                                    ...
                                                    <div class="row justify-content-end pt-5">
                                                        <div id="share" href="" style=" font: 16px/30px Cairo; color: #0E67CB; background: 0% 0% no-repeat padding-box; border-radius: 15px;" data-id="{{encrypt($card->id)}}" class="btn" data-toggle="modal" data-target="#shareModal"><img class="pr-2" src="img/Icon ionic-md-share.svg" alt=""/> Share</div>
                                                    </div>
                                                </div>

                                                <!-- share button Modal -->
                                                <div class="modal fade" id="shareModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel1" aria-hidden="true">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="row justify-content-center">
                                                                    ...
                                                                    <div class="col-md-2" style="margin-bottom: 9px">
                                                                        <a id="sendFb" href=""><img width="55 px" height="55 px" src="img/facebook.png" alt=""/></a>
                                                                    ...
                                                                    <div class="col-md-3 text-center"><a href="{{asset('img/defaultQr.png')}}" download="defaultQr.png"><img src="img/Download.svg" alt=""/></a>
                                                                ...
                                                                <div class="row justify-content-center">
                                                                    ...
                                                                    <button style="width: 100px;height: 47px" onclick="copy()" id="copy" class="pl-3 pt-2 btn btn-success ml-3 mt-1">Copy</button>
                                                                </div>
                                                                <span style="display:none;width:100%;margin-left:130px;font-weight: bold;" class="text-success" id="copied">Copied Successfully!</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div class="d-flex justify-content-center">
                                    {!! $cards->links('site.pages.bootstrap-4') !!}
                                </div>
                        </div>
