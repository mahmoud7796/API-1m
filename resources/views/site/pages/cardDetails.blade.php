...
<head>
    ...
    <style type="text/css">
        @import url("{{asset('public/css/style.css')}}");
        body {
        }
    </style>
            ...
            <div class="card-body p-5">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="row"> <a href="{{asset('public/'.$cards->qr_url)}}" download="{{$users->fullName.' Card'}}" style="font: 20px/32px Cairo; color: #FFFFFF" type="submit" class="btn btn-block" id="loginBtn">Download QR</a> </div>
                    </div>
