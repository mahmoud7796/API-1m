...
<div class="container-fluid">
  <nav class="navbar navbar-expand-lg fixed-top navbar-light">
    ...
    <div class="card col-md-8 border-0 shadow-lg my-5">
      <div class="card-bvody pt-5"> 
...
--> 
          ...
          <div style="border-top: 10px solid #9EC2EA; background-color: #F5F7FA; border-radius: 10px;" class="col-md-6 pl-3 mt-5">
            <div class="row">
              <div class="col-md-7">
                <div class="row pl-5 pt-5">
                  <h5 style="font: bold 20px/37px Cairo; color: #1F2933;">Card Details</h5>
              ...
              <div class="col-md-5">
                <div class="row pt-5 justify-content-center"><a href="" style="font: 16px/32px Cairo; color: #6B6B6B;" class="btn btn-block" id="saveChangesBtn">Save Changes</a></div>
                <div class="row justify-content-center">
                  <div class="col-md-4 pt-3"> <a href="" style=" font: 13px/30px Cairo; color: #1F2933; background: #E7A82D 0% 0% no-repeat padding-box; width: 71px; height: 40px; border-radius: 25px;" class="btn btn-block">4 Scans</a> </div>
                  <div class="col-md-4 pt-3"> <a href="" style=" font: 13px/30px Cairo; color: #FFFFFF; background: #77082E 0% 0% no-repeat padding-box; width: 71px; height: 40px; border-radius: 25px;" class="btn btn-block ">3 Adds</a> </div>
                </div>
                <div class="row pt-5 mt-4"></div>
                <div class="row justify-content-center pl-3 pr-3"><a href="" style="font: bold 16px/32px Cairo; " class="btn btn-block btn-outline-danger" id="deleteCardBtn" data-toggle="modal" data-target="#exampleModal4">Delete Card</a></div>
              </div>
              <!-- Modal -->
