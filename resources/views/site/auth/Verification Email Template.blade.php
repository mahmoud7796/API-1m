  ...
  <div style="" class="container" id="center">
    <div class="card o-hidden border-0 shadow-lg my-5">
      <div class="card-body p-5"> 
        ...
        <div class="row pt-5">
          <h3 style="font: normal normal bold 20px/32px Cairo;">Hello John,</h3>
        </div>
        <div class="row pt-5">
        ...
        <!-- Verify btn -->
        <div class="row pt-3"><a style="font: 20px/32px Cairo; color: #FFFFFF; background: #0D67CB 0% 0% no-repeat padding-box; box-shadow: 2px 2px 4px #00000029; border-radius: 15px; width: 211px; height: 53px;" type="submit" class="btn btn-block" id="">Verify Your Account</a> </div>
        <div class="row pt-3">
